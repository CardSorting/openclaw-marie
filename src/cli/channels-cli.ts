    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["marie channels list", "List configured channels and auth profiles."],
          ["marie channels status --probe", "Run channel status checks and probes."],
          [
            "marie channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["marie channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.marieai.com/cli/channels",
        )}\n`,
    );
